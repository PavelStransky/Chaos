...
\section{Gaussian random matrix ensembles}
    ...
    \subsection{Wigner semicircle law}
        ...
        \begin{equation}
            \overline{\rho}(E)=\int\d E_{2}\dotsb\d E_{N}P(E,E_{1},\dotsc,E_{N}),
        \end{equation}
...
\section{Statistical analysis of a general computed spectrum}
    ...
    \subsection{$1/f$ noise in quantum spectra}
...
\begin{thebibliography}{99}
    ...
    \bibitem{Ber89} Michael Berry, {\it Quantum Chaology, Not Quantum Chaos}, Physica Scripta {\bf 40}, 335 (1989).
    \bibitem{Boh84} Oriol Bohigas, Marie-Joya Giannoni, Carles Schmit, {\it Characterization of chaotic quantum spectra and universality of level fluctuation laws}, Physical Review Letters {\bf 52}, 1 (1984). 
    \bibitem{Cas85} Giulio Casati, Boris V. Chirikov, Italo Guarneri, {\it Energy-Level Statistics of Integrable Quantum Systems}, Physical Review Letters {\bf 54}, 1350 (1985).
    \bibitem{Wis28} John Wishart, {\it Generalized product moment distribution in samples}, Biometrica A {\bf 20}, 32 (1928).
    ...
    \bibitem{Wig55} Eugene Wigner, {\it Characteristic vectors of bordered matrices with many dimensions}, Annals of Mathematics {\bf 62}, 548 (1955).
    ...
    \bibitem{Dys62} Freeman John Dyson, {\it Statistical theory of the energy levels of complex systems I--III}, Journal of Mathematical Physics {\bf 3}, \{140, 157, 166\} (1962).
    \bibitem{Alt97} Alexander Altland, Martin R. Zirnbauer, {\it Nonstandard symmetry classes in mesoscopic normal-superconducting hybrid structures}, Physical Review B {\bf 55}, 1142 (1997).
    \bibitem{Gin65} Jean Ginibre, {\it Statistical Ensembles of Comples, Quaternion, and Real Matrices}, Journal of Mathematical Physics {\bf 6}, 440 (1965).
    \bibitem{Kac66} Mark Kac, {\it Can One Hear the Shape of a Drum?} American Mathematical Monthly {\bf 73}, 16 (1966).
\end{thebibliography}
