...
\section{Integrable systems}\label{sec:Integrable}
    ...
    \subsection{Nearest neighbour spacing distribution}
        ...
        \begin{task}\label{task:2Dbox}
            ...
            A detailed discussion of this system (concluding that the levels in the infinite well are, in fact, correlated) is given in Ref.~\cite{Cas85}.
        \end{task}
...
\section{Statistical analysis of a quantum spectrum}
    ...
    \subsection{Level density}
        ...
        It is given by the \emph{Gutzwiller trace formula}~\cite{Gut90}
        \begin{equation}
            \label{eq:Gutzwiller}
